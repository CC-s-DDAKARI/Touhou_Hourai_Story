...
* 더 이상 렌더링을 별도의 스레드에서 진행하지 않습니다.
  * 성능 이익에 비해 유지가 매우 어려운 단점이 있었습니다.
  * 또한, Release 모드 시 드로우콜을 진행하는 동안 CPU를 충분히 활용하기 때문에 렌더링 전용 스레드를 사용해서 얻을 수 있는 이익이 거의 없었습니다.
  * 여전히 다중 스레드를 이용하여 명령 목록을 작성합니다.
